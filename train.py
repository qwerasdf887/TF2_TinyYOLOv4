...
train_default = {'anchors': [[10, 14], [23, 27], [37, 58],
                           [81, 82], [135, 169], [344, 319]],
                 'anchors_mask': [[1, 2, 3], [3, 4, 5]], #原始 cfg 完全沒使用到[10, 14]這個anchor box，可以根據自己的物體評估要不要改成[0,1,2]訓練
                 'image_shape': (416, 416),
                 'num_classes': 80,
                 'score_threshold': 0.6,
                 'iou_threshold': 0.3,
...
if __name__ == "__main__":
    ...
    if train_default['use_pretrain']:
        ...
        load_weights(model, './yolov4-tiny.weights', custom_cls=custom)
